...
@Repository
interface AdditionalInformationRepositoryTest : BaseRepository<AdditionalInformation, Long>

@Repository
class AdditionalInformationRepositoryTestImpl(
    private val dbClient: DatabaseClient

) : AdditionalInformationRepositoryTest {
